#pragma checksum "C:\Users\MunozM12\OneDrive - BASF\Desktop\active-directory-verifiable-credentials-dotnet-main\1-asp-net-core-api-idtokenhint\Pages\Issuer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "35b44ba843ffe90358b31f2a6d9337c7b5ea3df9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"35b44ba843ffe90358b31f2a6d9337c7b5ea3df9", @"/Pages/Issuer.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 3 "C:\Users\MunozM12\OneDrive - BASF\Desktop\active-directory-verifiable-credentials-dotnet-main\1-asp-net-core-api-idtokenhint\Pages\Issuer.cshtml"
...
#nullable disable
                    ...
                    .then(function(response) {
                        ...
                        .then(function(message) {
                            ...
                            if( /Android/i.test(navigator.userAgent) ) {
                                console.log(`Androi");
            WriteLiteral(@"d device! Using deep link (${respIssuanceReq.url}).`);
             ...
             ");
            WriteLiteral(@"                       document.getElementById('pinCodeText').innerHTML = ""Pin code: "" + respIssuanceReq.pin;
                        ...
                        fetch('api/issuer/issuance-response?id=' + respIssuanceReq.id )
                            ...
                            .then(response => {
                                if (response.length > 0) {
                                    ...
                                    // QR Code scanned, s");
            WriteLiteral(@"how pincode if pincode is required
            ...
            WriteLiteral(@"'message').innerHTML = respMsg.message;
